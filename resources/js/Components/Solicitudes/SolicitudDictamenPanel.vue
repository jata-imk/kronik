...
<template>
    <section class="space-y-3 rounded border border-surface-200 p-4 dark:border-surface-700">
        ...
        <p v-else-if="!registros.some(item => item.revision_actual)" role="status">Pendiente: los dictámenes anteriores no corresponden a una revisión actualmente evaluable.</p>
