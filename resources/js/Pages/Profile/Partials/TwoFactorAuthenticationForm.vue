            ...
            <div class="mt-5">
                <div v-if="! twoFactorEnabled">
                    <ConfirmsPassword @confirmed="enableTwoFactorAuthentication">
                        <Button severity="contrast" type="button" class="uppercase font-semibold !text-xs" :class="{ 'opacity-25': enabling }" :disabled="enabling">
                            Habilitar
                        </Button>
                    </ConfirmsPassword>
                </div>
                ...
                <div v-else>
                    <ConfirmsPassword @confirmed="confirmTwoFactorAuthentication">
                        <Button severity="contrast"
                            v-if="confirming"
                            type="button"
                            class="me-3 uppercase font-semibold !text-xs"
