...
class SicsSeeder extends Seeder
{
    ...
    {
        Sic::create(['nombre' => 'Buró de Crédito', 'clave' => 'buro_credito']);
        Sic::create(['nombre' => 'Círculo de Crédito', 'clave' => 'circulo_credito']);

        SicApi::create(['sic_id' => 2, 'nombre' => "FICO® Score", 'clave' => "fico_score_v2"]);
        SicApi::create(['sic_id' => 2, 'nombre' => "Fintech Score", 'clave' => "fintech"]);
        SicApi::create(['sic_id' => 2, 'nombre' => "Reporte de Crédito Fico Score", 'clave' => "fico_score"]);
