...
class Domicilio implements ModelInterface, ArrayAccess
{
    ...
    protected static $apihubTypes = [
        ...
        'ciudad' => 'string',
        'estado' => '\App\Services\SICs\CirculoDeCredito\FicoScorev2\Model\CatalogoEstados',
        'cp' => 'string',
        'fecha_residencia' => 'string',
        'numero_telefono' => 'string',
        'tipo_domicilio' => '\App\Services\SICs\CirculoDeCredito\FicoScorev2\Model\CatalogoTipoDomicilio',
        'tipo_asentamiento' => '\App\Services\SICs\CirculoDeCredito\FicoScorev2\Model\CatalogoTipoAsentamiento',
