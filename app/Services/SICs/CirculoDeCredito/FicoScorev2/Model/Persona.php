...
class Persona implements ModelInterface, ArrayAccess
{
    ...
    protected static $apihubTypes = [
        ...
        'curp' => 'string',
        'nacionalidad' => 'string',
        'residencia' => '\App\Services\SICs\CirculoDeCredito\FicoScorev2\Model\CatalogoResidencia',
        'estado_civil' => '\App\Services\SICs\CirculoDeCredito\FicoScorev2\Model\CatalogoEstadoCivil',
        'sexo' => '\App\Services\SICs\CirculoDeCredito\FicoScorev2\Model\CatalogoSexo',
        'clave_elector_ife' => 'string',
        'numero_dependientes' => 'int',
        'fecha_defuncion' => 'string',
        'domicilio' => '\App\Services\SICs\CirculoDeCredito\FicoScorev2\Model\Domicilio'
    ];
