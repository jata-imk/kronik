...
class DomicilioRespuesta implements ModelInterface, ArrayAccess
{
    ...
    protected static $RCCPMTypes = [
        ...
        'ciudad' => 'string',
        'estado' => 'App\Services\SICs\CirculoDeCredito\RCFicoScore\Model\CatalogoEstados',
        'cp' => 'string',
        'fecha_residencia' => 'string',
        'numero_telefono' => 'string',
        'tipo_domicilio' => 'App\Services\SICs\CirculoDeCredito\RCFicoScore\Model\CatalogoTipoDomicilio',
        'tipo_asentamiento' => 'App\Services\SICs\CirculoDeCredito\RCFicoScore\Model\CatalogoTipoAsentamiento',
