...
return [
    ...
    'attributes' => [
        ...
        'resultado' => 'resultado de revisión',
        'fundamento' => 'fundamento del dictamen',
        'fuentes' => 'fuentes y evidencias revisadas',
        'nivel_riesgo' => 'nivel de riesgo',
        'metodologia' => 'metodología y versión utilizadas',
        'version_anterior' => 'versión anterior de la política',
        'modalidad' => 'modalidad de aprobación',
        'sic' => 'política SIC',
        'monto_maximo' => 'monto máximo',
        'vigencia_dias' => 'vigencia de aprobación en días',
        'documentos' => 'documentos requeridos',
        'documentos.*' => 'tipo de documento',
        'referencia_validacion' => 'referencia de validación del operador',
        'criterio_capacidad' => 'criterio de capacidad de pago',
        'confirmacion' => 'confirmación de la política',
        ...
        'contenido_html' => 'contenido de la plantilla',
        'encabezado_html' => 'encabezado de la plantilla',
